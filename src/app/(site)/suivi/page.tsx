...
import {
  ...
  releaseExpiredReservationsQuietly,
...
export default async function SuiviPage({
  ...
  const reviewOrder =
    order?.status === "livree" &&
    isBuyer(
      { reference: order.reference, userId: order.userId ?? null },
      sp.t,
      user,
    )
  ...
  return (
    <div className="shell py-10 lg:py-14">
      {/* Titre a gauche, recherche a droite sur ordinateur : toute la largeur sert. */}
      ...
      {order ? (
        <div className="card mt-8 p-6 lg:p-8">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:gap-12">
            ...
            <div className="min-w-0 border-t border-line pt-5 lg:border-l lg:border-t-0 lg:pl-12 lg:pt-0">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                {order.lines.map((line) => (
                  ...
                  >
                    ...
                    <span className="tabular shrink-0 whitespace-nowrap font-medium">
              ...
              <div className="mt-4 flex items-baseline justify-between border-t border-line pt-4">
                ...
                <span className="tabular whitespace-nowrap text-lg font-semibold">
              ...
              {order.paidAt || order.status === "livree" ? (
                documentsAccess ? (
                  ...
                  <p className="mt-5 text-sm text-fg-2">
                    La facture est disponible depuis le lien reçu par WhatsApp
                    ou par email, ou depuis votre compte si la commande y est
                    rattachée.
                  </p>
                )
              ) : null}
